...
public class ForkJoinPool extends AbstractExecutorService {
    ...
    /**
     * Factory for creating new {@link com.pheiot.bamboo.common.utils.concurrent.jsr166e.ForkJoinWorkerThread}s.
    ...
    public static interface ForkJoinWorkerThreadFactory {
         ...
         */
        public com.pheiot.bamboo.common.utils.concurrent.jsr166e.ForkJoinWorkerThread newThread(ForkJoinPool pool);
    }
    ...
    static final class DefaultForkJoinWorkerThreadFactory
        ...
        public final com.pheiot.bamboo.common.utils.concurrent.jsr166e.ForkJoinWorkerThread newThread(ForkJoinPool pool) {
            return new com.pheiot.bamboo.common.utils.concurrent.jsr166e.ForkJoinWorkerThread(pool);
        }
    }
    ...
    static final class WorkQueue {
        ...
        final com.pheiot.bamboo.common.utils.concurrent.jsr166e.ForkJoinWorkerThread owner; // owning thread or null if shared
        ...
        WorkQueue(ForkJoinPool pool, com.pheiot.bamboo.common.utils.concurrent.jsr166e.ForkJoinWorkerThread owner, int mode,
                  int seed) {
            this.pool = pool;
            this.owner = owner;
    ...
    private void tryAddWorker() {
        ...
        while ((u = (int) ((c = ctl) >>> 32)) < 0 &&
            ...
            if (U.compareAndSwapLong(this, CTL, c, nc)) {
                ...
                Throwable ex = null;
                com.pheiot.bamboo.common.utils.concurrent.jsr166e.ForkJoinWorkerThread wt = null;
                try {
                    if ((fac = factory) != null &&
     ...
     */
    final WorkQueue registerWorker(com.pheiot.bamboo.common.utils.concurrent.jsr166e.ForkJoinWorkerThread wt) {
     ...
     */
    final void deregisterWorker(com.pheiot.bamboo.common.utils.concurrent.jsr166e.ForkJoinWorkerThread wt, Throwable ex) {
        WorkQueue w = null;
    ...
    static int getSurplusQueuedTaskCount() {
        ...
        if (((t = Thread.currentThread()) instanceof com.pheiot.bamboo.common.utils.concurrent.jsr166e.ForkJoinWorkerThread)) {
            int p = (pool = (wt = (com.pheiot.bamboo.common.utils.concurrent.jsr166e.ForkJoinWorkerThread) t).pool).parallelism;
    ...
    public boolean awaitQuiescence(long timeout, TimeUnit unit) {
        ...
        if ((thread instanceof com.pheiot.bamboo.common.utils.concurrent.jsr166e.ForkJoinWorkerThread) &&
                (wt = (com.pheiot.bamboo.common.utils.concurrent.jsr166e.ForkJoinWorkerThread) thread).pool == this) {
     ...
     * is a {@link com.pheiot.bamboo.common.utils.concurrent.jsr166e.ForkJoinWorkerThread}, this method possibly
