package com.pheiot.bamboo.common.utils.time;
...
public class DateFormatUtilTest {
    ...
    public void formatDuration() {
        ...
        System.out.println(DateFormatUtil.formatDuration(100));
        assertThat(DateFormatUtil.formatDuration(100)).isEqualTo("0:00:00.100");

        assertThat(DateFormatUtil.formatDuration(new Date(100), new Date(3000))).isEqualTo("0:00:02.900");
