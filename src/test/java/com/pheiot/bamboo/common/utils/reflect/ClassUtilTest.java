...
public class ClassUtilTest {
    ...
    public void getMessage() {
        ...
        assertThat(ClassUtil.getPackageName(ClassUtilTest.class)).isEqualTo("com.dmsoft.bamboo.common.utils.reflect");
        assertThat(ClassUtil.getPackageName(BClass.class)).isEqualTo("com.dmsoft.bamboo.common.utils.reflect");
        assertThat(ClassUtil.getPackageName(ClassUtilTest.class.getName()))
                .isEqualTo("com.dmsoft.bamboo.common.utils.reflect");
        assertThat(ClassUtil.getPackageName(BClass.class.getName())).isEqualTo("com.dmsoft.bamboo.common.utils.reflect");
    ...
    public void classPresent() {
        ...
        assertThat(ClassUtil.isPresent("ClassUtil", ClassUtil.getDefaultClassLoader())).isTrue();
    }
