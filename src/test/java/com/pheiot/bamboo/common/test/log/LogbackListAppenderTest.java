 ...
 *******************************************************************************/
package com.pheiot.bamboo.common.test.log;
...
public class LogbackListAppenderTest {
    ...
    public void addAndRemoveAppender() {
        ...
        // name
        appender.clearLogs();
        appender.addToLogger("com.dmsoft.bamboo.common.test.log");
        logger.warn(testString);
        assertThat(appender.getFirstLog()).isNotNull();

        appender.clearLogs();
        appender.removeFromLogger("com.dmsoft.bamboo.common.test.log");
        logger.warn(testString);
        assertThat(appender.getFirstLog()).isNull();
    }
}
